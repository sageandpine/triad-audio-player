...
class Triad():
    ...
    def __init__(self, is_playing=False):
        ...
        self.play_button = ttk.Button(mainframe, text=self.pl_var, command=self.play_it).grid(column=1, row=3, sticky=E)
        ...
        self.open_button = ttk.Button(mainframe, text="Open", command=self.open_it).grid(column=5, row=3, sticky=W)
